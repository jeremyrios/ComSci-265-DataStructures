...
const int QUIT1 = 8282;
const int QUIT2 = 4646;
...
const string DIRECTORY("L:\\Computer Programing\\COMSC 265\\Final Project\\");
...
void displayBoard();
bool chooseFisrtCard();
bool chooseSecondCard();
...
/*************************/
bool chooseFisrtCard()										//to input the first point
{
...
/****************************************************/
bool chooseSecondCard()										//to input the second point 
{
  goTo(bottomCol,bottomRow);
